...
public class PublicPrivateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addresses.add(addresOne);
        addresses.add(addresTwo);
        addresses.add(addresThree);
        addresses.add(addresFour);
        addresses.add(addresFive);
        ...
        imageReturn = findViewById(R.id.image_return_one);
        tvDataDesign = findViewById(R.id.tv_information_three);

        index = rand.nextInt(5);

        classAddress.setText(addresses.get(index));
