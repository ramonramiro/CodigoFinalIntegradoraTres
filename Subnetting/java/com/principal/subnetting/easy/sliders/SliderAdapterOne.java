...
public class SliderAdapterOne extends PagerAdapter{
    ...
    Context contextSliderUnitOne;
    LayoutInflater layoutInflater;


    public SliderAdapterOne(Context context){
        this.contextSliderUnitOne = context;    }

    //Arrays
    public int[] slideImages = {
            R.drawable.ic_pag_one,
            R.drawable.ic_pag_two,
            R.drawable.ic_pag_three
    };
...
/*
    ...
    */
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        layoutInflater = (LayoutInflater) contextSliderUnitOne.getSystemService(contextSliderUnitOne.LAYOUT_INFLATER_SERVICE);
