...
import com.principal.subnetting.easy.fragments.AditionalsFragment;
...
public class MenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circleMenu.setMainMenu(Color.parseColor(getString(R.string.color_green)), R.mipmap.icon_menu, R.mipmap.icon_cancel)
                .addSubMenu(Color.parseColor(getString(R.string.color_whit)), R.drawable.ic_unit_one)
                ...
                .addSubMenu(Color.parseColor(getString(R.string.color_whit)), R.drawable.ic_unit_two)
                .addSubMenu(Color.parseColor(getString(R.string.color_whit)), R.drawable.ic_unit_three)
                .addSubMenu(Color.parseColor(getString(R.string.color_whit)), R.drawable.ic_unit_four)
                .addSubMenu(Color.parseColor(getString(R.string.color_whit)),R.drawable.ic_unit_five);
